...
<body>
    ...
    <main>
        ...
        <h3>Select an option to filter meals by overall cooking time.</h3>

        <div id="filters">
            <label><input type="checkbox" value="short"> Short (less than 20 mins)</label>
            <label><input type="checkbox" value="medium"> Medium (20-45 mins)</label>
            <label><input type="checkbox" value="long"> Long (45+ mins)</label>
        </div>
        ...
        <section class="meal-category">
            ...
            <div class="meal-container">
                <div class="meal-section" data-tags="long">
                ...
                <div class="meal-section" data-tags="medium">
                ...
                <div class="meal-section" data-tags="short">
    ...
    document.querySelectorAll("#filters input").forEach(checkbox => {
        checkbox.addEventListener("change", function () {
            ...
            let mealSelections = document.querySelectorAll(".meal-section");
            mealSelections.forEach(mealSection => {
                let mealTags = mealSection.getAttribute("data-tags").split(", ").map(tag => tag.trim());

                let matches = selectedTags.every(tag => mealTags.includes(tag));
